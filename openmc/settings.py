    ...
    **kwargs : dict, optional
    ...
    delta_tracking : dict
        ...
        :hybrid_type:
            ...
            (str). Valid options are 'cross_section' for the approach taken by
            Serpent, or 'energy' for the hybrid-in-energy approach proposed by
            J. P. Morgan et al. (see https://doi.org/10.1080/23324309.2026.2618791).
            'cross_section' is the default.
        :xs_threshold:
        ...
        :neutron_energy_threshold:
            The neutron energy threshold to use when running hybrid-in-energy
            ...
            tracking is used. 50 keV is used by default.
        :photon_energy_threshold:
            The photon energy threshold to use when running hybrid-in-energy
            ...
            tracking is used. 1 MeV is used by default.
